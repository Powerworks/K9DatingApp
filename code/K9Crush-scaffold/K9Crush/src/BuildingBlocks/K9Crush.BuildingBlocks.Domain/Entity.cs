...
/// <summary>
/// Base type for document-centric entities (Identity, Profiles, Subscriptions,
/// Media, Moderation, Notifications). These are current-state documents stored
/// directly via Marten's document store - no event stream.
/// </summary>
public abstract class Entity
{
    ...
    // settable members unless told otherwise. See DogProfile.cs for the
    // fuller writeup of this pattern (private ctor + private setters +
