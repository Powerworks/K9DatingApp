...
#   project_dir — path to the project root; defaults to code/K9Crush-scaffold/K9Crush
#                 (build-kit-dotnet/ is a sibling of the target project under the
#                 repo root here, not its parent, unlike the original build-kit/ layout)

set -euo pipefail

KIT_DIR="$(cd "$(dirname "$0")" && pwd)"
ITERATIONS="${1:-0}"
PROJECT_DIR="${2:-"$KIT_DIR/code/K9Crush-scaffold/K9Crush"}"
