...
// build-kit-dotnet/ is a sibling of the target project under the repo root
// (not nested, unlike the original build-kit/ layout), so the default can't
// just be "parent of kitDir".
